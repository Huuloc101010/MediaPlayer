...
static inline const char* err2str(int errnum)
{
    thread_local static char buf[AV_ERROR_MAX_STRING_SIZE];
    av_strerror(errnum, buf, sizeof(buf));
    return buf;
}
 
static inline const char* ts2timestr(int64_t ts, AVRational tb)
{
    thread_local static char buf[AV_TS_MAX_STRING_SIZE];
